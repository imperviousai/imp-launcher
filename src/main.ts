 ...
 */
 ...
 import "./app/ipc/main";
 import { spawnBrowser, spawnImpervious, initDownloadInfo, writeVersionInformation } from "./module";
 ...
 export const createUpdateWindow = (): void => {
  ...
  updateWindow.loadURL(MAIN_WINDOW_WEBPACK_ENTRY + "#/update");
 }
 ...
 app.on("ready", async () => {
   ...
   if (os.platform() === "darwin"){
    ...
    require('update-electron-app')({
     ...
     writeVersionInformation("mac-imp-launcher");
   }
